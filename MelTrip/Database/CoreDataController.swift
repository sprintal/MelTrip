...
class CoreDataController: NSObject, DatabaseProtocol, NSFetchedResultsControllerDelegate {
    ...
    func createDefaultEntries() {
        ...
        let _ = addLocation(name: "Carlton Gardens", introduction: "Carlton Gardens is a gorgeously landscaped Victorian-era park that sits among impressive company. It's here you'll find the heritage-listed Royal Exhibition Building and the Melbourne Museum. Go for a stroll early morning to see the park at its most eye-catching.", latitude: -37.8054312, longtude: 144.9692237, image: "Carlton Gardens", type: 2)
    }
}
